...
/*
    ...
    "user" : "65d86065e4aa635e545b1d71dcc8894c35ab686a",
    ...
    */
        ...
        var conf = {};
        conf['endpoint'] = "https://htk.tlu.ee/lrs/data/xAPI/";
        try
        {
            conf['auth'] = "Basic " + toBase64('65d86065e4aa635e545b1d71dcc8894c35ab686a:cffe0080f36cc30383c0c9f9a075cd5030e75838');
        }
        catch (e)
        {
    ...
    */
    ...
    XAPIWrapper.prototype.getStatements = function(searchparams, more, callback)
    {
        if (this.testConfig())
        {
            ...
            this.lrs.auth = 'Basic NjVkODYwNjVlNGFhNjM1ZTU0NWIxZDcxZGNjODg5NGMzNWFiNjg2YTpjZmZlMDA4MGYzNmNjMzAzODNjMGM5ZjlhMDc1Y2Q1MDMwZTc1ODM4';
